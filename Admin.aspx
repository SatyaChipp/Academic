...
UpdateCommand="UPDATE ListDetails SET catName = @catName, items = @items, ingredients = @ingredients, small = @small, medium = @medium, large = @large, images = @images WHERE itemID = @itemID
   ">
                    ...
                    <br />
                    <div>
                       <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlItemList"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="small" HeaderText="PETIT" SortExpression="small" DataFormatString="{0:c}" />
                                <asp:BoundField DataField="medium" HeaderText="MOYEN" SortExpression="medium" DataFormatString="{0:c}" />
                                <asp:BoundField DataField="large" HeaderText="GRANDE'" SortExpression="large" DataFormatString="{0:c}" />
                                <asp:TemplateField HeaderText="IMAGE" SortExpression="images">
                                   <%--<EditItemTemplate>
