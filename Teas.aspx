...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="page">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myDB %>" SelectCommand="SELECT itemID, catName, items, ingredients, small, medium, large, images FROM ListDetails WHERE catName = 'tea'"></asp:SqlDataSource>
